...
public class XML2ivo_vrCrosswalk extends Crosswalk {
  ...
  static {
    ...
    String contextUrl = conf.getString("org.vamdc.registry.url", "");
    schemaLocationBase = contextUrl + "/schema";
  }
  ...
  public boolean isAvailableFor(Object nativeItem) {
    ...
    return (fullItem.contains("<" + elementName)) || (fullItem.contains("<" + prefix + ":" + elementName));
  }

  /**
   * Perform the actual crosswalk.
   *
   * @param nativeItem the native "item". In this case, it is already formatted
   * as an OAI <record> element, with the possible exception that multiple
  ...
  public String createMetadata(Object nativeItem)
    ...
    try {
      ...
      if (nl.getLength() > 0) {
        int tempIndex;
        StringBuilder resContent = new StringBuilder(DomHelper.ElementToString((org.w3c.dom.Element) nl.item(0)));
        ...
        if (!temp.contains("schemaLocation") && versionStr.equals("1.0")) {
